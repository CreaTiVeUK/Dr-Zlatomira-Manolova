...
export const en = {
    ...
    admin: {
        ...
        usersPage: {
            ...
            subtitle: "Review patient accounts, open detailed profiles, and jump straight into session recording when needed.",
        ...
        sessionLogsPage: {
            unavailableTitle: "Session logs are temporarily unavailable.",
            unavailableDescription: "The production database has not been migrated to the latest schema yet.",
            eyebrow: "Session logs",
            title: "Session logs & feedback",
            subtitle: "Review AI summaries, revisit uploaded recordings, and jump directly into the relevant patient profile.",
            filterLabel: "Filter patients",
            newSession: "New session",
            emptyTitle: "No sessions match your criteria",
            emptyDescription: "Try adjusting the filter or start a new recording from a patient profile.",
            unknownPatient: "Unknown patient",
            recorded: "Recorded",
            addDoc: "Add doc",
            profile: "Profile",
            aiSummary: "AI session summary",
            noSummary: "No summary available.",
            latestPatientNote: "Latest patient note",
            noVisitNotes: "No notes provided for this visit.",
            fromVisitOn: "From visit on",
            noRecentNotes: "No recent appointment notes found for this patient.",
            fullTranscription: "View full transcription",
            transcription: "Transcription",
            allPatients: "All patients",
        },
        userDetailPage: {
            notFoundTitle: "Patient not found",
            notFoundDescription: "The requested patient record could not be located.",
            backToUsers: "Back to users",
            noPhone: "No phone number",
            children: "Children",
            childrenUnavailableTitle: "Children unavailable",
            childrenUnavailableDescription: "Child records will appear here after the latest database migration is applied.",
            noChildrenTitle: "No children listed",
            noChildrenDescription: "This patient account does not have child profiles yet.",
            medicalDocuments: "Medical documents",
            documentsUnavailableTitle: "Medical documents are temporarily unavailable.",
            documentsUnavailableDescription: "Apply the latest production database migration to restore documents and AI session logs.",
            uploadNewDocument: "Upload new document",
            existingFiles: "Existing files",
            documentsUnavailableEmptyTitle: "Documents unavailable",
            documentsUnavailableEmptyDescription: "Document storage is not available in this environment yet.",
