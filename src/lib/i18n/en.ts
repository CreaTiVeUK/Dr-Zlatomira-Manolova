    ...
    admin: {
        ...
        securityPage: {
            ...
            twoFactor: {
                ...
                description: "Require a 6-digit code from an authenticator app at every sign-in.",
                enabled: "Enabled",
                disabled: "Disabled",
            },
        },
        auditLogsPage: {
            ...
            title: "Audit log",
            subtitle: "Every administrative and privileged action is recorded here for review.",
            ...
            emptyDescription: "Adjust the filters above or clear them to see the full log.",
            previous: "Previous",
            next: "Next",
            pageInfo: "Page %s",
        },
