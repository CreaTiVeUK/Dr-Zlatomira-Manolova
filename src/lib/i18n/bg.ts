...
export const bg: Dictionary = {
    ...
    resources: {
        ...
        faq: {
            ...
            items: [
                { q: "Как да запазя час за спешен преглед?", a: "Свободните часове за спешни случаи се обявяват всеки ден в 08:30 ч. Моля, обадете се директно в нашата клиника на +359 88 5557110." },
                ...
                { q: "Клиниката работи ли с частни здравни застраховки?", a: "Работим с водещи български здравни застрахователи, включително ДЗИ, Алианц и Дженерали. За потвърждение преди преглед се свържете с нас на +359 88 5557110." },
                ...
                { q: "Има ли паркинг в близост до клиниката?", a: "Клиниката се намира в Ж.К. Тракия, където има широк достъп до паркинг в близост до адрес А11, кв. Захари Зограф, 52Б." }
            ]
        },
        cta: {
