...
export const bg: Dictionary = {
    ...
    resources: {
        ...
        faq: {
            ...
            items: [
                { q: "Предлагате ли телемедицински консултации?", a: "Да, за последващи прегледи и общи съвети предлагаме сигурни видео консултации. Свържете се с нас за повече информация." },
                { q: "На каква възраст се приемат деца?", a: "Д-р Манолова-Пенева приема деца от 0 до 18 години — от новородени до юноши." },
                { q: "Как да подготвя детето за първи преглед?", a: "Носете здравната книжка на детето и документ за самоличност. Ако детето е кърмаче, вземете и любима играчка за успокоение. Персоналът ни ще ви напъти при пристигане." },
