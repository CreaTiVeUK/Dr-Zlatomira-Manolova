...
export const bg: Dictionary = {
    ...
    home: {
        ...
        services: {
            ...
            general: {
                ...
                desc: "Експертно управление на остри състояния, висока температура и инфекции. Рутинни профилактични прегледи и консултации по имунизационния календар.",
                btn: "ВИЖТЕ УСЛУГАТА →"
            },
            allergy: {
    ...
    contact: {
        ...
        medicalCenter: "АИПСМП ПО ПЕДИАТРИЯ „Д-Р ЗЛАТОМИРА МАНОЛОВА-ПЕНЕВА“ (Пловдив)",
        partnerHospital: "МБАЛ Пазарджик",
        addressMain: "А11, кв. „Захари Зограф“, ж.к. Тракия, 4000 Пловдив, България",
        addressSecond: "Пазарджик, България",
        tel: "Тел",
    ...
    servicesPage: {
        ...
        general: {
            ...
            list: [
                ...
                "• Профилактични прегледи и консултации за ваксини",
    ...
    resources: {
        ...
        faq: {
            ...
            items: [
                ...
                { q: "Как да подготвя детето за първи преглед?", a: "Носете здравната книжка на детето и документ за самоличност. Ако детето е кърмаче, вземете и любима играчка за успокоение." },
                ...
                { q: "Поставят ли се ваксини в кабинета?", a: "Ваксини не се поставят в кабинета. Д-р Манолова-Пенева консултира родителите относно националния имунизационен календар — срокове, препоръчителни ваксини и подготовка на детето." },
