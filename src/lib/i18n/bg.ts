    ...
    resources: {
        ...
        faq: {
            ...
            items: [
                ...
                { q: "Предлагате ли ваксинации по националния имунизационен календар?", a: "Да, в клиниката се извършват всички ваксини по националния имунизационен календар на България, включително профилактични прегледи при кърмачета." },
