    ...
    resources: {
        ...
        faq: {
            ...
            items: [
                ...
                { q: "Как да подготвя детето за първи преглед?", a: "Носете медицинска документация на детето и документ за самоличност. Ако детето е кърмаче, вземете и любима играчка за успокоение. Персоналът ни ще Ви напъти при пристигане." },
