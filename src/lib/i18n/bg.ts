...
export const bg: Dictionary = {
    ...
    home: {
        ...
        about: {
            ...
            bio3: "През 2025 г. д-р Манолова печели конкурс и оглавява Второ педиатрично отделение на МБАЛ Пазарджик. Нейната визия включва пълно обновяване на средата за малките пациенти – инициатива, която стартира с преобразяването на отделението от млади художници, за да превърне „детския плач в усмивка”.",
    ...
    resources: {
        ...
        faq: {
            ...
            items: [
                ...
                { q: "На каква възраст се приемат деца?", a: "Д-р Манолова приема деца от 0 до 18 години — от новородени до юноши." },
