...
export const metadata: Metadata = {
  ...
  description: "Частен педиатър в Пловдив. Д-р Златомира Манолова-Пенева — специалист педиатрия, грижа за новородени, профилактични прегледи. Кабинет в кв. Тракия. Запазете час онлайн.",
  keywords: [
    "педиатър Пловдив", "детски лекар Пловдив", "д-р Манолова-Пенева", "д-р Манолова", "частен педиатър",
    "грижа за новородени Пловдив", "детски специалист Пловдив",
    "pediatrician Plovdiv", "pediatric specialist Bulgaria",
  ],
  openGraph: {
    title: "Детски лекар Пловдив — Д-р Златомира Манолова-Пенева",
    description: "Частен педиатър в Пловдив. Спешна и обща педиатрия, грижа за новородени, профилактични прегледи. Запазете час онлайн.",
    siteName: "Педиатрия Манолова-Пенева",
    images: [{ url: "/og-default.jpg", width: 1448, height: 758, alt: "Д-р Манолова-Пенева — Педиатър Пловдив" }],
    locale: "bg_BG",
    type: "website",
    url: SITE_URL,
  },
...
const structuredData = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      "medicalSpecialty": "https://schema.org/Pediatric",
      "knowsAbout": ["Педиатрия", "Грижа за новородени", "Спешна педиатрия", "Профилактични прегледи"],
