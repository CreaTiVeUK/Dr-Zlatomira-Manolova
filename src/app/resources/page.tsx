...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    description: "Експертни педиатрични съвети, ЧЗВ и статии от д-р Манолова-Пенева. Температура при бебета, ваксини, хранене, развитие — практични отговори за родители.",
