...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    description: "Д-р Златомира Манолова-Пенева — педиатър в Пловдив. Специалност по педиатрия (2023), началник на Второ педиатрично отделение в МБАЛ Пазарджик. Грижа за новородени и профилактични прегледи.",
